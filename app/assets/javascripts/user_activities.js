...
window.nucleus.controller('UserActivitiesCtrl', ['$scope', '$rootScope', 'ActivityService', function($scope, $rootScope, ActivityService){
...
window.nucleus.controller('UserActivityCtrl', ['$scope', '$rootScope', 'ActivityService', function($scope, $rootScope, ActivityService){
...
window.nucleus.controller('RightPanelCtrl', ['$scope', '$rootScope', 'ActivityService', function($scope, $rootScope, ActivityService){
...
window.nucleus.directive('rowColor', function () {
    return {
        restrict: 'A',
