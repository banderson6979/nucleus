window.nucleus.controller('TrackerCtrl', ['$scope', '$rootScope', '$timeout', 'ActivityService', function($scope, $rootScope, $timeout, ActivityService){
    var isStarted = false;
...
window.nucleus.controller('TrackerSideBarCtrl', ['$scope', '$rootScope',function($scope, $rootScope){
